Spree.ready ($) ->
  Spree.onPayment = () ->
    if ($ '#checkout_form_payment').is('*')
      ...
      $('#checkout_form_payment').submit (e) ->
        ...
        if (coupon_code != '')
          if coupon_code == 'prelaunch-1' or coupon_code == 'prelaunch-2' or coupon_code == 'prelaunch-3' or coupon_code == 'prelaunch-4'
            coupon_code = '4qFLCQL3ZeK2y7m'
